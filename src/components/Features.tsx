...
export default function Features() {
  ...
  return (
    <section id="features" className="w-full py-24 " style={{ backgroundColor: theme === "light" ? "#fff" : "#111827" }}>
    <div className="container mx-auto"> 
      ...
      {/* Left: Visual - Feature Cards Grid */}
          <div className="relative">
            ...
            <div className="relative grid grid-cols-2 gap-4">
              {features.map((feature, idx) => (
                <div
                  key={idx}
                  className={`p-6 rounded-2xl ${idx % 2 === 1 ? "mt-8" : ""}`}
                  style={{ 
                ...
                >
                  <div className={`w-12 h-12 bg-linear-to-r ${feature.color} rounded-xl flex items-center justify-center mb-4 shadow-lg`}>
                    <div className="text-white">{feature.icon}</div>
                  </div>
                  <h3 className={`font-semibold mb-2 ${theme === "dark" ? "text-white" : "text-gray-900"}`}>{feature.title}</h3>
          ...
          {/* Right: Content */}
          <div className={`animate-slide-in-right ml-[90] px-5 ${theme === "dark" ? "text-white" : "text-gray-700"}`}>
