      ...
      <div className="mx-auto px-4 py-20">
        ...
        <div className="max-w-4xl mx-auto">
          <div className={`glass-card p-8 md:p-12 rounded-2xl`}>
            ...
            <div className="mb-10">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-gradient-to-r from-[#018589] to-[#015f65] rounded-2xl flex items-center justify-center">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mb-10">
              ...
              <div className={`mt-4 p-4 rounded-xl ${theme === "dark" ? "bg-gray-800" : "bg-gray-100"}`}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className={`font-semibold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>PCI Service Provider Level 1 Certified</p>
