      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="text-center mb-10">
          ...
          <h1 className={`text-3xl md:text-4xl font-bold mt-6 mb-4 ${theme === "dark" ? "text-white" : "text-gray-900"}`}>
            Refund <span className="text-[#018589]">Policy</span>
          </h1>
        ...
        <div className={`p-8 md:p-12 rounded-2xl ${theme === "dark" ? "bg-gray-900/50" : "bg-gray-50 border border-gray-200"}`}>
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ background: "linear-gradient(to right, #018589, #015f65)" }}>
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className={`leading-relaxed ${theme === "dark" ? "text-gray-300" : "text-gray-900"}`}>
              Our customers enjoy the flexibility to cancel their subscription at any time, whether during the free trial period of the demo page or after purchasing a paid subscription. Cancellation can be easily done from their personal space on our platform, through a few intuitive clicks, or by contacting us via email.
               </p>
          </div>

          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ background: "linear-gradient(to right, #dc2626, #ea580c)" }}>
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={`p-6 border rounded-xl ${theme === "dark" ? "bg-red-900/20 border-red-800" : "bg-red-50 border-red-200"}`}>
              <p className={`m-0 ${theme === "dark" ? "text-gray-300" : "text-gray-900"}`}>
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ background: "linear-gradient(to right, #2563eb, #06b6d4)" }}>
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
